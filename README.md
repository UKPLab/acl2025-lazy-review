...
>
The repository contains codes to reproduce the zero-shot experiments for the paper along iwth instruction-tuning LLMs on our newly released dataset, ```LazyReview```. We support chat versions of the LLaMa, Gemma, Qwen, Yi, Mistral and SciTulu family of models.
